package com.ems.yudao.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import com.ems.yudao.framework.common.pojo.PageResult;
import com.ems.yudao.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.ems.yudao.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.ems.yudao.module.mp.convert.message.MpMessageConvert;
import com.ems.yudao.module.mp.dal.dataobject.account.MpAccountDO;
import com.ems.yudao.module.mp.dal.dataobject.message.MpMessageDO;
import com.ems.yudao.module.mp.dal.dataobject.user.MpUserDO;
import com.ems.yudao.module.mp.dal.mysql.message.MpMessageMapper;
import com.ems.yudao.module.mp.enums.message.MpMessageSendFromEnum;
import com.ems.yudao.module.mp.framework.mp.core.MpServiceFactory;
import com.ems.yudao.module.mp.framework.mp.core.util.MpUtils;
import com.ems.yudao.module.mp.service.account.MpAccountService;
import com.ems.yudao.module.mp.service.material.MpMaterialService;
import com.ems.yudao.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.ems.yudao.module.mp.service.user.MpUserService;
...
import static com.ems.yudao.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
