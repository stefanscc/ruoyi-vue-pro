package com.ems.yudao.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.ems.yudao.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
