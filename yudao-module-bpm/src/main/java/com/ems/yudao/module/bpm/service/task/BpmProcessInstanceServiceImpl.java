package com.ems.yudao.module.bpm.service.task;
...
import com.ems.yudao.framework.common.util.collection.CollectionUtils;
import com.ems.yudao.framework.common.util.date.DateUtils;
import com.ems.yudao.framework.common.util.json.JsonUtils;
import com.ems.yudao.framework.common.util.object.ObjectUtils;
import com.ems.yudao.framework.common.util.object.PageUtils;
import com.ems.yudao.framework.datapermission.core.annotation.DataPermission;
import com.ems.yudao.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.ems.yudao.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.ems.yudao.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.ems.yudao.module.bpm.controller.admin.task.vo.instance.*;
import com.ems.yudao.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.ems.yudao.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.ems.yudao.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.ems.yudao.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.ems.yudao.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.ems.yudao.module.bpm.enums.ErrorCodeConstants;
import com.ems.yudao.module.bpm.enums.definition.BpmModelTypeEnum;
import com.ems.yudao.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.ems.yudao.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.ems.yudao.module.bpm.enums.task.BpmReasonEnum;
import com.ems.yudao.module.bpm.enums.task.BpmTaskStatusEnum;
import com.ems.yudao.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.ems.yudao.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.ems.yudao.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.ems.yudao.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.ems.yudao.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.ems.yudao.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.ems.yudao.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.ems.yudao.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.ems.yudao.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.ems.yudao.module.bpm.service.definition.BpmProcessDefinitionService;
import com.ems.yudao.module.bpm.service.message.BpmMessageService;
...
import static com.ems.yudao.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.ems.yudao.module.bpm.enums.ErrorCodeConstants.*;
import static com.ems.yudao.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.ems.yudao.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
