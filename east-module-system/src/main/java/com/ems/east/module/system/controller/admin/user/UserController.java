package com.ems.east.module.system.controller.admin.user;
...
import com.ems.east.module.system.controller.admin.user.vo.user.*;
import com.ems.east.module.system.convert.user.UserConvert;
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@iocoder.cn").mobile("15601691300")
                        .nickname("EMS").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
