...
import cn.iocoder.east.module.system.dal.dataobject.dept.PostDO;
...
import cn.iocoder.east.module.system.enums.common.SexEnum;
...
import static cn.iocoder.east.framework.common.util.collection.SetUtils.asSet;
...
import static cn.iocoder.east.framework.test.core.util.RandomUtils.randomString;
import static cn.iocoder.east.module.system.enums.ErrorCodeConstants.USER_PASSWORD_FAILED;
...
class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    private static AdminUserDO randomAdminUserDO(Consumer<AdminUserDO>... consumers) {
        ...
        return randomPojo(AdminUserDO.class, cn.iocoder.east.framework.common.util.collection.ArrayUtils.append(base, consumers));
    }
