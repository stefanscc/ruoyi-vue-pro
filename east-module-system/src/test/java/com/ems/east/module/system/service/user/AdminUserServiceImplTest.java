...
import com.ems.east.module.system.dal.dataobject.dept.PostDO;
...
import com.ems.east.module.system.enums.common.SexEnum;
...
import static com.ems.east.module.system.enums.ErrorCodeConstants.USER_PASSWORD_FAILED;
...
class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    private static AdminUserDO randomAdminUserDO(Consumer<AdminUserDO>... consumers) {
        ...
        return randomPojo(AdminUserDO.class, com.ems.east.framework.common.util.collection.ArrayUtils.append(base, consumers));
    }
