package com.ems.east.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.ems.east.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "EMS，牛逼！")
    @ExcelProperty("结果提示")
