package cn.iocoder.east.module.infra.controller.admin.job.vo.job;
...
import cn.iocoder.east.module.infra.enums.DictTypeConstants;
...
public class JobRespVO {
    ...
    @Schema(description = "处理器的参数", example = "east")
