package cn.iocoder.east.module.infra.framework.file.core.s3;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.IdUtil;
import cn.iocoder.east.framework.common.util.validation.ValidationUtils;
import cn.iocoder.east.module.infra.framework.file.core.client.s3.S3FileClient;
import cn.iocoder.east.module.infra.framework.file.core.client.s3.S3FileClientConfig;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.east.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.east.iocoder.cn
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://t151glocd.hn-bkt.clouddn.com"); // 如果有自定义域名，则可以设置。http://static.east.iocoder.cn
        config.setEnablePathStyleAccess(false);
        // 默认上海的 endpoint
        config.setEndpoint("s3-cn-south-1.qiniucs.com");
