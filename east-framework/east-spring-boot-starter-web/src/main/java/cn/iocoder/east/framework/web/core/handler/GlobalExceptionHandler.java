package cn.iocoder.east.framework.web.core.handler;
...
import cn.iocoder.east.framework.common.biz.infra.logger.ApiErrorLogCommonApi;
...
import cn.iocoder.east.framework.common.exception.util.ServiceExceptionUtil;
import cn.iocoder.east.framework.common.pojo.CommonResult;
import cn.iocoder.east.framework.common.util.collection.SetUtils;
...
import cn.iocoder.east.framework.web.core.util.WebFrameworkUtils;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> defaultExceptionHandler(HttpServletRequest req, Throwable ex) {
        ...
        // 例如说：https://gitee.com/zhijiantianya/east-cloud/issues/ICSSRM、https://gitee.com/zhijiantianya/east-cloud/issues/ICT6FM
    ...
    private CommonResult<?> handleTableNotExists(Throwable ex) {
        ...
        if (StrUtil.containsAny(message,
                "report_", "bpm_", "mp_",
                "product_", "promotion_", "trade_",
                "erp_", "crm_", "pay_", "ai_", "iot_")) {
            log.warn("Detected request for a module table that is not part of the EMS base edition: {}", message);
            return CommonResult.error(NOT_IMPLEMENTED.getCode(), "当前能力未纳入 EMS 基础版");
        }
        return null;
    }
