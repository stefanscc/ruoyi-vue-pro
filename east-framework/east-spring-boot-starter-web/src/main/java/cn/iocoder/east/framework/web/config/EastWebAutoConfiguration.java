package cn.iocoder.east.framework.web.config;
...
import cn.iocoder.east.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.east.framework.web.core.filter.DemoFilter;
import cn.iocoder.east.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.east.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class EastWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "east.demo", havingValue = "true")
