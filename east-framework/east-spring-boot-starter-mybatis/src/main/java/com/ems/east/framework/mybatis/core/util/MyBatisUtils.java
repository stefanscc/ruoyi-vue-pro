package com.ems.east.framework.mybatis.core.util;
...
import com.ems.east.framework.common.pojo.SortingField;
import com.ems.east.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
     ...
     *
     * 使用场景：
     * 1. 修复商品统计聚合函数的别名与排序字段不符导致的 SQL 异常
     *
