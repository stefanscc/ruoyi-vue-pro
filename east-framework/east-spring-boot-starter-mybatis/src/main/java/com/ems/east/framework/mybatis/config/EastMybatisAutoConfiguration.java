package com.ems.east.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.ems.east.framework.common.util.json.JsonUtils;
import com.ems.east.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${east.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class EastMybatisAutoConfiguration {

    static {
        // 动态 SQL 智能优化支持本地缓存加速解析，并为复杂 XML 动态 SQL 提供静态注入缓存
