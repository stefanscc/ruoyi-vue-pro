package com.ems.yudao.module.iot.core.messagebus.config;

import com.ems.yudao.framework.mq.redis.core.RedisMQTemplate;
import com.ems.yudao.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.ems.yudao.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.ems.yudao.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.ems.yudao.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.ems.yudao.module.iot.core.messagebus.core.IotMessageBus;
import com.ems.yudao.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.ems.yudao.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.ems.yudao.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
     ...
     *
     * @see com.ems.yudao.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration
     */
    @Configuration
