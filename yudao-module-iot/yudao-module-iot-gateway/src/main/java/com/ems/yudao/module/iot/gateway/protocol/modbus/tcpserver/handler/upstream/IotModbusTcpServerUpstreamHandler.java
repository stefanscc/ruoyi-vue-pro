package com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.ems.yudao.framework.common.exception.ServiceException;
import com.ems.yudao.framework.common.exception.enums.GlobalErrorCodeConstants;
import com.ems.yudao.framework.common.pojo.CommonResult;
import com.ems.yudao.framework.common.util.json.JsonUtils;
import com.ems.yudao.module.iot.core.biz.IotDeviceCommonApi;
import com.ems.yudao.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import com.ems.yudao.module.iot.core.biz.dto.IotDeviceRespDTO;
import com.ems.yudao.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import com.ems.yudao.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.ems.yudao.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.ems.yudao.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import com.ems.yudao.module.iot.core.mq.message.IotDeviceMessage;
import com.ems.yudao.module.iot.core.topic.IotDeviceIdentity;
import com.ems.yudao.module.iot.core.util.IotDeviceAuthUtils;
import com.ems.yudao.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.ems.yudao.module.iot.gateway.service.device.IotDeviceService;
import com.ems.yudao.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.ems.yudao.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.ems.yudao.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.ems.yudao.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.ems.yudao.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
