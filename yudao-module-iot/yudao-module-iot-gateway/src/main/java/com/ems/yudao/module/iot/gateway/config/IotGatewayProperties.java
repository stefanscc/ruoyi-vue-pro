package com.ems.yudao.module.iot.gateway.config;

import com.ems.yudao.module.iot.core.enums.IotProtocolTypeEnum;
import com.ems.yudao.module.iot.gateway.protocol.coap.IotCoapConfig;
import com.ems.yudao.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import com.ems.yudao.module.iot.gateway.protocol.http.IotHttpConfig;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import com.ems.yudao.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import com.ems.yudao.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import com.ems.yudao.module.iot.gateway.protocol.tcp.IotTcpConfig;
import com.ems.yudao.module.iot.gateway.protocol.udp.IotUdpConfig;
import com.ems.yudao.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
import lombok.Data;
...
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see com.ems.yudao.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see com.ems.yudao.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
