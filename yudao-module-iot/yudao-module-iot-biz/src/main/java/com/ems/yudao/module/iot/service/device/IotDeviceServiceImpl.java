package com.ems.yudao.module.iot.service.device;
...
import com.ems.yudao.framework.common.util.validation.ValidationUtils;
import com.ems.yudao.framework.tenant.core.aop.TenantIgnore;
import com.ems.yudao.framework.tenant.core.util.TenantUtils;
import com.ems.yudao.module.iot.controller.admin.device.vo.device.*;
import com.ems.yudao.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import com.ems.yudao.module.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
import com.ems.yudao.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.ems.yudao.module.iot.core.enums.device.IotDeviceStateEnum;
...
import com.ems.yudao.module.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import com.ems.yudao.module.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import com.ems.yudao.module.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import com.ems.yudao.module.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import com.ems.yudao.module.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import com.ems.yudao.module.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import com.ems.yudao.module.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import com.ems.yudao.module.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import com.ems.yudao.module.iot.core.util.IotDeviceAuthUtils;
import com.ems.yudao.module.iot.core.util.IotProductAuthUtils;
import com.ems.yudao.module.iot.dal.dataobject.device.IotDeviceDO;
import com.ems.yudao.module.iot.dal.dataobject.device.IotDeviceGroupDO;
import com.ems.yudao.module.iot.dal.dataobject.product.IotProductDO;
import com.ems.yudao.module.iot.dal.mysql.device.IotDeviceMapper;
import com.ems.yudao.module.iot.dal.redis.RedisKeyConstants;
import com.ems.yudao.module.iot.enums.product.IotProductDeviceTypeEnum;
import com.ems.yudao.module.iot.service.device.message.IotDeviceMessageService;
import com.ems.yudao.module.iot.service.product.IotProductService;
...
import static com.ems.yudao.module.iot.enums.ErrorCodeConstants.*;
