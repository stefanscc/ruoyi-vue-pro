...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ems.boot";
    private static final String ARTIFACT_ID = "east";
    private static final String PACKAGE_NAME = "com.ems.east";
