...
`east.file.base-path=${user.home}/.east/files`

配置位置：

- [application.yaml](/home/xcao/project/ruoyi-vue-pro-jdk17/east-server/src/main/resources/application.yaml)

如果需要切换目录，只改 `east.file.base-path` 即可。
...
- [FileController.http](/home/xcao/project/ruoyi-vue-pro-jdk17/east-module-infra/src/main/java/cn/iocoder/east/module/infra/controller/admin/file/FileController.http)
