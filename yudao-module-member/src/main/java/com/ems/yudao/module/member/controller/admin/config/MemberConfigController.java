package com.ems.yudao.module.member.controller.admin.config;

import com.ems.yudao.framework.common.pojo.CommonResult;
import com.ems.yudao.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.ems.yudao.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.ems.yudao.module.member.convert.config.MemberConfigConvert;
import com.ems.yudao.module.member.dal.dataobject.config.MemberConfigDO;
import com.ems.yudao.module.member.service.config.MemberConfigService;
