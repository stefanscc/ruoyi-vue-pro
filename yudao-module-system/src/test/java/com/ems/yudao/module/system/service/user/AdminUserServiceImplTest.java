package com.ems.yudao.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.ems.yudao.framework.common.enums.CommonStatusEnum;
import com.ems.yudao.framework.common.exception.ServiceException;
import com.ems.yudao.framework.common.pojo.PageResult;
import com.ems.yudao.framework.common.util.collection.ArrayUtils;
...
import com.ems.yudao.module.infra.api.config.ConfigApi;
import com.ems.yudao.module.infra.api.file.FileApi;
import com.ems.yudao.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.ems.yudao.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.ems.yudao.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.ems.yudao.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.ems.yudao.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.ems.yudao.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.ems.yudao.module.system.dal.dataobject.dept.DeptDO;
import com.ems.yudao.module.system.dal.dataobject.dept.PostDO;
import com.ems.yudao.module.system.dal.dataobject.dept.UserPostDO;
import com.ems.yudao.module.system.dal.dataobject.tenant.TenantDO;
import com.ems.yudao.module.system.dal.dataobject.user.AdminUserDO;
import com.ems.yudao.module.system.dal.mysql.dept.UserPostMapper;
import com.ems.yudao.module.system.dal.mysql.user.AdminUserMapper;
import com.ems.yudao.module.system.enums.common.SexEnum;
import com.ems.yudao.module.system.service.dept.DeptService;
import com.ems.yudao.module.system.service.dept.PostService;
import com.ems.yudao.module.system.service.oauth2.OAuth2TokenService;
import com.ems.yudao.module.system.service.permission.PermissionService;
import com.ems.yudao.module.system.service.tenant.TenantService;
...
import static com.ems.yudao.framework.common.util.collection.SetUtils.asSet;
import static com.ems.yudao.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.ems.yudao.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.ems.yudao.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.ems.yudao.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.ems.yudao.framework.test.core.util.AssertUtils.assertServiceException;
import static com.ems.yudao.framework.test.core.util.RandomUtils.*;
import static com.ems.yudao.module.system.enums.ErrorCodeConstants.*;
import static com.ems.yudao.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
