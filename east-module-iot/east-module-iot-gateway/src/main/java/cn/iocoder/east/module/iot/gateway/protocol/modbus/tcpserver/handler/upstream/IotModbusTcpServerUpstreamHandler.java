package cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.iocoder.east.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.iocoder.east.framework.common.pojo.CommonResult;
import cn.iocoder.east.framework.common.util.json.JsonUtils;
import cn.iocoder.east.module.iot.core.biz.IotDeviceCommonApi;
import cn.iocoder.east.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.iocoder.east.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.iocoder.east.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.iocoder.east.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.iocoder.east.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.iocoder.east.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
...
import cn.iocoder.east.module.iot.core.util.IotDeviceAuthUtils;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.iocoder.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.iocoder.east.module.iot.gateway.service.device.IotDeviceService;
import cn.iocoder.east.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.iocoder.east.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.iocoder.east.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.iocoder.east.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.iocoder.east.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
