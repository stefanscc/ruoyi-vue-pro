package com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.ems.east.framework.common.exception.enums.GlobalErrorCodeConstants;
import com.ems.east.framework.common.pojo.CommonResult;
import com.ems.east.framework.common.util.json.JsonUtils;
import com.ems.east.module.iot.core.biz.IotDeviceCommonApi;
import com.ems.east.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import com.ems.east.module.iot.core.biz.dto.IotDeviceRespDTO;
import com.ems.east.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import com.ems.east.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.ems.east.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.ems.east.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
...
import com.ems.east.module.iot.core.util.IotDeviceAuthUtils;
import com.ems.east.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.ems.east.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.ems.east.module.iot.gateway.service.device.IotDeviceService;
import com.ems.east.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.ems.east.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.ems.east.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.ems.east.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.ems.east.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
