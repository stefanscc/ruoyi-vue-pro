package com.ems.east.module.iot.mq.consumer.device;
...
import com.ems.east.module.iot.core.messagebus.core.IotMessageSubscriber;
...
public class IotDeviceMessageSubscriber implements IotMessageSubscriber<IotDeviceMessage> {
    ...
    public void onMessage(IotDeviceMessage message) {
        ...
        devicePropertyService.updateDeviceReportTimeAsync(device.getId(), reportTime);
        // 1.2 更新设备的连接 server
