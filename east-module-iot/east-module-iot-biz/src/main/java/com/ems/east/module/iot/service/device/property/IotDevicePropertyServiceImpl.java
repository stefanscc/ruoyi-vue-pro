package com.ems.east.module.iot.service.device.property;
...
import com.ems.east.framework.common.util.object.ObjectUtils;
import com.ems.east.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import com.ems.east.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import com.ems.east.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import com.ems.east.module.iot.dal.dataobject.product.IotProductDO;
import com.ems.east.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import com.ems.east.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import com.ems.east.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import com.ems.east.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import com.ems.east.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import com.ems.east.module.iot.dal.tdengine.IotDevicePropertyMapper;
import com.ems.east.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import com.ems.east.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import com.ems.east.module.iot.framework.tdengine.core.TDengineTableField;
...
import com.ems.east.module.iot.service.thingmodel.IotThingModelService;
...
import static com.ems.east.framework.common.util.collection.CollectionUtils.*;
import static com.ems.east.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @曹操：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
