...
import com.ems.east.framework.common.util.date.LocalDateTimeUtils;
...
import com.ems.east.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import com.ems.east.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO 曹操：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @曹操：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
