package cn.iocoder.east.module.iot.service.device.property;
...
import cn.iocoder.east.framework.common.util.object.ObjectUtils;
import cn.iocoder.east.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import cn.iocoder.east.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import cn.iocoder.east.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import cn.iocoder.east.module.iot.dal.dataobject.product.IotProductDO;
import cn.iocoder.east.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import cn.iocoder.east.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import cn.iocoder.east.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import cn.iocoder.east.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.iocoder.east.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import cn.iocoder.east.module.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.iocoder.east.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.iocoder.east.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import cn.iocoder.east.module.iot.framework.tdengine.core.TDengineTableField;
...
import cn.iocoder.east.module.iot.service.thingmodel.IotThingModelService;
...
import static cn.iocoder.east.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void updateDeviceReportTimeAsync(Long id, LocalDateTime reportTime) {
        deviceReportTimeRedisDAO.updateIfNewer(id, reportTime);
    }
