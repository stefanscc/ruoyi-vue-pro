...
import cn.iocoder.east.framework.common.util.validation.ValidationUtils;
import cn.iocoder.east.module.iot.controller.admin.device.vo.device.*;
import cn.iocoder.east.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.iocoder.east.module.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
...
import cn.iocoder.east.module.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import cn.iocoder.east.module.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import cn.iocoder.east.module.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import cn.iocoder.east.module.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import cn.iocoder.east.module.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import cn.iocoder.east.module.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import cn.iocoder.east.module.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import cn.iocoder.east.module.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import cn.iocoder.east.module.iot.core.util.IotDeviceAuthUtils;
import cn.iocoder.east.module.iot.core.util.IotProductAuthUtils;
import cn.iocoder.east.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.iocoder.east.module.iot.dal.dataobject.device.IotDeviceGroupDO;
import cn.iocoder.east.module.iot.dal.dataobject.product.IotProductDO;
import cn.iocoder.east.module.iot.dal.mysql.device.IotDeviceMapper;
import cn.iocoder.east.module.iot.dal.redis.RedisKeyConstants;
import cn.iocoder.east.module.iot.enums.product.IotProductDeviceTypeEnum;
import cn.iocoder.east.module.iot.service.device.message.IotDeviceMessageService;
import cn.iocoder.east.module.iot.service.product.IotProductService;
...
import static cn.iocoder.east.framework.common.exception.util.ServiceExceptionUtil.exception;
import static cn.iocoder.east.framework.common.util.collection.CollectionUtils.convertList;
import static cn.iocoder.east.module.iot.enums.ErrorCodeConstants.*;
...
public class IotDeviceServiceImpl implements IotDeviceService {
    ...
    public void updateDeviceState(IotDeviceDO device, Integer state) {
        updateDeviceState(device, state, null);
    }

    @Override
    public void updateDeviceState(IotDeviceDO device, Integer state, @Nullable LocalDateTime stateTime) {
        // 1. 更新状态和时间
        LocalDateTime actualStateTime = stateTime != null ? stateTime : LocalDateTime.now();
