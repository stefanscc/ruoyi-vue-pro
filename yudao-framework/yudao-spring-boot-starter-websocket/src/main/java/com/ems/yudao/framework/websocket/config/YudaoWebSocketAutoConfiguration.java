package com.ems.yudao.framework.websocket.config;

import com.ems.yudao.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import com.ems.yudao.framework.mq.redis.core.RedisMQTemplate;
import com.ems.yudao.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.ems.yudao.framework.websocket.core.listener.WebSocketMessageListener;
import com.ems.yudao.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.ems.yudao.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.ems.yudao.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.ems.yudao.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.ems.yudao.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.ems.yudao.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.ems.yudao.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.ems.yudao.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.ems.yudao.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.ems.yudao.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.ems.yudao.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.ems.yudao.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.ems.yudao.framework.websocket.core.session.WebSocketSessionManager;
import com.ems.yudao.framework.websocket.core.session.WebSocketSessionManagerImpl;
