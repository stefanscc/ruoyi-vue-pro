package com.ems.yudao.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default com.ems.yudao.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            com.ems.yudao.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new com.ems.yudao.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
