...
import com.ems.yudao.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import com.ems.yudao.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import com.ems.yudao.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import com.ems.yudao.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return com.ems.yudao.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
