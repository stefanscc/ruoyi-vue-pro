...
import com.ems.yudao.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import com.ems.yudao.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import com.ems.yudao.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import com.ems.yudao.module.mes.enums.qc.MesQcCheckResultEnum;
...
import com.ems.yudao.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public com.ems.yudao.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return com.ems.yudao.framework.common.pojo.PageResult.empty();
            }
