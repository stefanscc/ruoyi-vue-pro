package com.ems.yudao.module.ai.service.chat;
...
import com.ems.yudao.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.ems.yudao.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.ems.yudao.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.ems.yudao.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.ems.yudao.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.ems.yudao.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.ems.yudao.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.ems.yudao.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.ems.yudao.module.ai.dal.dataobject.model.AiModelDO;
import com.ems.yudao.module.ai.dal.dataobject.model.AiToolDO;
import com.ems.yudao.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.ems.yudao.module.ai.enums.ErrorCodeConstants;
import com.ems.yudao.module.ai.enums.model.AiPlatformEnum;
import com.ems.yudao.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.ems.yudao.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.ems.yudao.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.ems.yudao.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.ems.yudao.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.ems.yudao.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.ems.yudao.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.ems.yudao.module.ai.service.model.AiChatRoleService;
import com.ems.yudao.module.ai.service.model.AiModelService;
import com.ems.yudao.module.ai.service.model.AiToolService;
import com.ems.yudao.module.ai.util.AiUtils;
import com.ems.yudao.module.ai.util.FileTypeUtils;
...
import static com.ems.yudao.framework.common.pojo.CommonResult.error;
import static com.ems.yudao.framework.common.pojo.CommonResult.success;
import static com.ems.yudao.framework.common.util.collection.CollectionUtils.convertList;
import static com.ems.yudao.framework.common.util.collection.CollectionUtils.convertSet;
import static com.ems.yudao.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.ems.yudao.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
